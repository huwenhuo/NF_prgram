...
params.contrast_sheet = "${projectDir}/mpp8_samplesheet_fixed.csv"
...
workflow {
    ...
    // 7. downstrea of coding gene analysis and summary based on TECOUNT
    DESEQ2_CODING(
        ch_merged_matrix.matrix,
        ch_fixed_samplesheet
    )
    ...
    // 9. downstream scTE / scTELocal analyses

    // 10. downstream IRFinder analysis
    ...
    // 11. Collect QC logs for MultiQC
